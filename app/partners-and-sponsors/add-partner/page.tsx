...
//   const [selectedEvents, setSelectedEvents] = useState<string[]>(["AfroSpook 2025", "Bass Revolution", "Summer Vibes Festival"])
...
//           <button className="border-2 border-[#cca33a] py-2 px-6 rounded-full text-sm text-[#cca33a] flex gap-2 items-center">
//             <LuSave />
//             Save & Publish
//           </button>
//           <button className="hover:bg-gray-600 py-2 px-6 rounded-full text-sm text-white font-semibold">
//             Cancel
//           </button>
//         </div>
//       </section>
